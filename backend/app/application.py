"""
Application factory using OOP principles.
"""
import logging
import os
    ...
    def _configure_events(self):
        ...
        async def startup_event():
            ...
            try:
                ...
                await init_beanie(database=db, document_models=[User, Business, Restaurant, Store, Pharmacy, Kitchen, Item, ItemCategory])
