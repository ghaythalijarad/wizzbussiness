"""
Centralized platform integration controller.
"""
...
class CentralizedPlatformController:
    """Controller for centralized platform integration."""
    ...
    async def test_platform_connection(
        ...
        try:
            result = await centralized_platform_service.test_connection(session)
            return {
    ...
    async def get_platform_apps(
        ...
        try:
            apps = await centralized_platform_service.get_platform_apps(session)
            return {
    ...
    async def deploy_centralized_app(
        ...
        try:
            result = await centralized_platform_service.deploy_centralized_app(app_config, session)
            return {
    ...
    async def sync_business_to_platform(
        ...
        try:
            ...
            # Sync to platform
            result = await centralized_platform_service.sync_business_data(business, session)
    ...
    async def sync_all_businesses_to_platform(
        ...
        try:
            # Get all businesses
            businesses = await business_service.get_all_businesses_unified(session)
    ...
    async def get_platform_sync_status(
        ...
        try:
            # Test connection
            connection_test = await centralized_platform_service.test_connection(session)
    ...
    async def setup_centralized_platform(
        ...
        try:
            ...
            deploy_result = await centralized_platform_service.deploy_centralized_app(app_config, session)
            setup_results.append({
                "step": "app_deployment",
            ...
            for business in businesses:
                try:
                    sync_result = await centralized_platform_service.sync_business_data(business, session)
