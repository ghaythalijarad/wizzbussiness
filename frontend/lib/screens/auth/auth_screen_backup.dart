  ...
  Widget _buildPhotoUploadField(
    ...
    return Container(
      ...
      child: ListTile(
        ...
        title: Text(
          currentPath != null ? 'Photo selected' : label, // Will be localized
          style: TextStyle(
        ...
        subtitle: Text(
          currentPath != null ? 'Tap to change photo' : hint, // Will be localized
          style: TextStyle(
            color: Theme.of(context).colorScheme.onSurfaceVariant,
          ),
        ),
        trailing: Icon(
          currentPath != null ? Icons.check_circle : Icons.camera_alt,
          color: currentPath != null 
            ? Theme.of(context).colorScheme.primary 
            : Theme.of(context).colorScheme.onSurfaceVariant,
        ),
      ...
      child: ListTile(
        ...
        title: Row(
          children: [
            Expanded(
              child: Text(
                currentPath != null ? 'Document uploaded' : label,
                style: TextStyle(
                  color: currentPath != null 
                    ? Theme.of(context).colorScheme.primary 
                    : Theme.of(context).colorScheme.onSurfaceVariant,
        ...
        subtitle: Text(
          currentPath != null ? 'Tap to change document' : hint, // Will be localized
          style: TextStyle(
            color: Theme.of(context).colorScheme.onSurfaceVariant,
          ),
        ),
        trailing: Icon(
          currentPath != null ? Icons.check_circle : Icons.upload_file,
          color: currentPath != null 
            ? Theme.of(context).colorScheme.primary 
            : Theme.of(context).colorScheme.onSurfaceVariant,
        ),
        onTap: () => _pickDocument(onChanged),
      ),
    );
  }
  
  void _pickBusinessPhoto() {
    // Simulate photo picker
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: const Text('Photo picker would open here'), // Will be localized
        backgroundColor: Theme.of(context).colorScheme.primary,
      ),
    );
    // For demo purposes, simulate a selected photo
    // setState(() {
    //   _businessPhotoPath = 'demo_business_photo.jpg';
    // });
  }
  
  void _pickDocument(Function(String?) onChanged) {
    // Simulate document picker
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: const Text('Document picker would open here'), // Will be localized
        backgroundColor: Theme.of(context).colorScheme.primary,
      ),
    );
    // For demo purposes, simulate a selected document
    onChanged('demo_document.pdf');
  }
