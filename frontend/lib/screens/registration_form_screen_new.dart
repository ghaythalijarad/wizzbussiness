...
class _RegistrationFormScreenState extends State<RegistrationFormScreen> {
  ...
  String? _validateIraqiPhone(String? value) {
    ...
    final iraqiMobileRegex =
        RegExp(r'^\+964(77[0-9]|78[0-9]|79[0-9])[0-9]{7}$');
    final iraqiLandlineRegex = RegExp(r'^\+964[1-9][0-9]{6,8}$');

    if (!iraqiMobileRegex.hasMatch(cleanPhone) &&
        !iraqiLandlineRegex.hasMatch(cleanPhone)) {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(file != null ? l10n.changeFile : l10n.selectFile),
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text('Name: ${_businessNameController.text}'),
                Text('Type: ${_selectedBusinessType ?? 'Not selected'}'),
                Text('Phone: ${_phoneController.text}'),
                Text('Email: ${_emailController.text}'),
                const SizedBox(height: 8),
                const Text('Owner Information:',
                    style: TextStyle(fontWeight: FontWeight.bold)),
                Text('Name: ${_ownerNameController.text}'),
                Text('National ID: ${_ownerNationalIdController.text}'),
                Text('Date of Birth: ${_ownerDateOfBirthController.text}'),
                const SizedBox(height: 8),
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Address Section (keep as requested)
                ...
                // Document Section (keep as requested)
