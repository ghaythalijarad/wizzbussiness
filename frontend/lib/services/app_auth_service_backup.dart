...
class AppAuthService {
  ...
  static Future<void> initialize() async {
    ...
    if (AppConfig.isCognitoConfigured) {
      // Initialize CognitoAuthService with proper Amplify configuration
      _cognitoService = CognitoAuthService();
      // Note: configure method expects amplify config string, not individual params
      // For now, we'll rely on Amplify being configured in main.dart
    }
