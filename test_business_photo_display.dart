...
void main() {
  ...
  final businessWithPhoto = Business(
    ...
    businessPhotoUrl: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=500&h=500&fit=crop',
    offers: [],
    businessHours: {},
    settings: {},
  ...
  final jsonWithPhoto = {
    ...
    'business_photo_url': 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=500&h=500&fit=crop',
  ...
  print('2. ✅ Business.fromJson() parses business_photo_url and businessPhotoUrl');
