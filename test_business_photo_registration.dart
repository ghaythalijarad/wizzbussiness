...
Future<void> main() async {
  ...
  final testEmail = 'photo_test_${DateTime.now().millisecondsSinceEpoch}@example.com';
  ...
  try {
    ...
    final registrationData = {
      ...
      'street': 'Test Street',
      'country': 'Iraq',
      'businessPhotoUrl': 'https://example.com/test-business-photo.jpg', // Mock photo URL
    };
    ...
    print('📊 Registration Response Status: ${registrationResponse.statusCode}');
    ...
    if (registrationResponse.statusCode == 200) {
      ...
      if (regData['success'] == true) {
        ...
        if (signinResponse.statusCode == 200) {
          ...
          if (signinData['success'] == true && signinData['businesses'] != null) {
            ...
            if (businesses.isNotEmpty) {
              ...
              print('🖼️ Business Photo URL: ${business['business_photo_url']}');
              
              if (business['business_photo_url'] == 'https://example.com/test-business-photo.jpg') {
                print('✅ Business photo URL stored correctly!');
              } else {
                print('⚠️ Business photo URL mismatch:');
                print('   Expected: https://example.com/test-business-photo.jpg');
            ...
            print('Note: This might be expected if email verification is required');
          }
        } else {
      ...
      print('❌ Registration request failed: ${registrationResponse.statusCode}');
