...
const String baseUrl = 'https://72nmgq5rc4.execute-api.us-east-1.amazonaws.com/dev';
...
Future<void> testBusinessPhotoUpload() async {
  try {
    ...
    if (response.statusCode == 200) {
      ...
      if (responseData['success'] == true) {
        ...
        print('❌ FAILED: Upload request was processed but returned success: false');
        print('💬 Message: ${responseData['message']}');
      }
    } else {
  ...
  print('✅ If successful, users can now upload business photos during registration!');
  print('='*60);
}
