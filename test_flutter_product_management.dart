...
class ProductManagementTest {
  ...
  static Future<String?> getAccessToken() async {
    try {
      final file = await File('/Users/ghaythallaheebi/order-receiver-app-2/access_token.txt').readAsString();
      return file.trim();
    } catch (e) {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true) {
          ...
          print('✅ GET /products successful - Found ${products.length} products');
  ...
  static Future<void> testGetProduct(String token, String productId) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('❌ GET /products/$productId failed with status: ${response.statusCode}');
      }
    } catch (e) {
  ...
  static Future<void> testUpdateProduct(String token, String productId) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('❌ PUT /products/$productId failed with status: ${response.statusCode}');
      }
    } catch (e) {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true) {
          ...
          print('✅ GET /categories successful - Found ${categories.length} categories');
